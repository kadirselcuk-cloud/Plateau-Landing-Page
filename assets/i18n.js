// Plateau i18n dictionary — Turkish (default) + English
window.PLATEAU_I18N = {
  tr: {
    nav: {
      platform: "Platform",
      products: "Ürünler",
      solutions: "Çözümler",
      resources: "Referanslar",
      company: "Hakkında",
      demo: "Demo Talep Et",
      studio: "Plateau Studio",
      workflow: "Plateau Workflow",
    ...
    products: {
      eyebrow: "PLATEAU ÜRÜN AİLESİ",
      title: "Her biri bağımsız, birlikte daha güçlü.",
    ...
    refs: {
      eyebrow: "REFERANSLAR",
      title: "Türkiye'nin ve bölgenin önde gelen kurumları Plateau ile çalışıyor.",
      note: "Logo alanları — gerçek müşteri logoları için ayrılmıştır."
    },
    testimonials: {
    ...
    footer: {
      tagline: "Be on the rise.",
      about: "Plateau, Softtech tarafından geliştirilen uçtan uca AI-native bir yazılım geliştirme platformudur. Softtech, Türkiye İş Bankası'nın bir iştirakidir.",
      col_products: "Ürünler",
      col_platform: "Platform",
      col_company: "Şirket",
      col_resources: "Kaynaklar",
      company_links: ["Hakkımızda", "Kariyer", "İletişim", "Basın"],
      resource_links: ["Dokümanlar", "Blog", "Vaka çalışmaları", "Destek"],
      platform_links: ["AI özellikleri", "Güvenlik", "Uyumluluk", "Mimariler"],
      legal: "© 2026 Softtech. Tüm hakları saklıdır. Plateau, Softtech'in tescilli bir ürünüdür.",
      parent: "Softtech, Türkiye İş Bankası iştirakidir."
    },
    pages: {
      studio: {
  ...
  en: {
    ...
    products: {
      eyebrow: "THE PLATEAU PRODUCT FAMILY",
      title: "Independent on their own. Stronger together.",
    ...
    refs: {
      eyebrow: "REFERENCES",
      title: "Leading institutions across Türkiye and the region run on Plateau.",
      note: "Logo slots — reserved for real customer logos."
    },
    testimonials: {
    ...
    footer: {
      tagline: "Be on the rise.",
      about: "Plateau is an end-to-end, AI-native software development platform built by Softtech. Softtech is a subsidiary of Türkiye İş Bankası.",
      col_products: "Products",
      col_platform: "Platform",
      col_company: "Company",
      col_resources: "Resources",
      company_links: ["About", "Careers", "Contact", "Press"],
      resource_links: ["Docs", "Blog", "Case studies", "Support"],
      platform_links: ["AI capabilities", "Security", "Compliance", "Architectures"],
      legal: "© 2026 Softtech. All rights reserved. Plateau is a registered product of Softtech.",
      parent: "Softtech is a subsidiary of Türkiye İş Bankası."
    },
    pages: {
      studio: {
...
// Language state + helpers shared across pages
(function(){
  const KEY = 'plateau_lang';
  window.getLang = () => localStorage.getItem(KEY) || 'tr';
  window.setLang = (lang) => { localStorage.setItem(KEY, lang); document.documentElement.lang = lang; };
})();
