export const DEMO_URL = 'https://softtech.com.tr/demorequest?product=Plateau%20Platform';

export const PLATEAU_I18N = {
  tr: {
    nav: {
      platform: "Platform",
      products: "Ürünler",
    ...
    footer: {
      about: "Plateau, Softtech tarafından geliştirilen uçtan uca AI-native bir yazılım geliştirme platformudur.",
      col_products: "Ürünler",
      col_contact: "İletişim",
      contact_address: "Reşitpaşa Mah. Katar Cad. İTÜ Teknokent ARI-3 Kat:4-5, 34467 Sarıyer / İstanbul",
      contact_phone: "+90 850 290 6000",
      contact_web: "www.softtech.com.tr",
    ...
    pages: {
      ...
      framework: {
        ...
        body: "Plateau Framework; mikroservislerin belirli bir standart ve kalitede geliştirilmesine olanak sağlayan kurumsal frameworktür. Ölçeklenebilir ve dağıtık uygulama geliştirmeyi kolaylaştırır. 650+ geliştirici ve 1.350+ mikroservisyle kanıtlanmış yazılım geliştirme altyapısı.",
        features: [
  ...
  en: {
    ...
    footer: {
      about: "Plateau is an end-to-end, AI-native software development platform built by Softtech.",
...
const LANG_KEY = 'plateau_lang';
export const getLang = () => localStorage.getItem(LANG_KEY) || 'tr';
